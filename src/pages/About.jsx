...
import { Heart, Eye, Target, Users, Award, Lightbulb, Star, CheckCircle } from 'lucide-react'
...
export default function About() {
  const values = [
    {
      ...
      description: 'Baseados em princípios cristãos sólidos que guiam todas nossas ações e decisões diárias.'
    },
    {
      icon: Users,
      title: 'Compromisso Integral',
      description: 'Dedicação completa com a cidadania e desenvolvimento social das comunidades que atendemos.'
    },
    {
      icon: Award,
      title: 'Respeito',
      description: 'Às pessoas e ao meio ambiente em todas as nossas iniciativas e projetos desenvolvidos.'
    },
    {
      icon: Lightbulb,
      title: 'Humildade e Amor',
      description: 'Confiança e amor ao próximo como base fundamental de nosso trabalho missionário.'
    }
  ]
  ...
  const principles = [
    {
      title: 'Integralidade',
      description: 'Cuidamos de cada aspecto do desenvolvimento da criança, desde educação até nutrição.',
      color: 'from-primary-500 to-primary-600',
      icon: CheckCircle
    },
    {
      title: 'Inovação',
      description: 'Sempre buscando novas formas de fazer a diferença na vida das crianças.',
      color: 'from-blue-500 to-blue-600',
      icon: Star
    },
    {
      title: 'Diversidade',
      description: 'Respeitamos e celebramos as diferenças e particularidades de cada criança.',
      color: 'from-purple-500 to-purple-600',
      icon: Users
    },
    {
      title: 'Transparência',
      description: 'Clareza em todas nossas ações e prestação de contas com a comunidade.',
  ...
  const achievements = [
    { value: '200+', label: 'Famílias Atendidas', icon: Users },
    { value: '9', label: 'Atividades Oferecidas', icon: Heart },
    { value: '100%', label: 'Dedicação e Amor', icon: Star },
    { value: '5+', label: 'Anos de História', icon: Award }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              O sorriso é a marca da esperança. Todos nós precisamos de alguém torcendo por nós. 
              Conheça nossa missão de transformar vidas através do amor e da educação.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12 mb-20">
            ...
            >
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                ...
                oferecendo oportunidades de crescimento e desenvolvimento integral para um futuro melhor.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/90 text-lg leading-relaxed">
                ...
                de uma sociedade justa, igualitária e que coloque crianças e adolescentes como prioridade absoluta.
              </p>
            </motion.div>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Nossos Valores em <span className="text-primary-600">Detalhes</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Os valores que norteiam cada uma de nossas ações e decisões no dia a dia
            </p>
          </motion.div>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Nossos Princípios de <span className="text-primary-600">Atuação</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Pilares fundamentais que sustentam nossa metodologia de trabalho e relacionamento com a comunidade
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-r from-gray-50 to-white rounded-3xl p-8 md:p-12 text-center"
          >
            ...
            <p className="text-lg text-gray-500 max-w-3xl mx-auto">
              ...
              construindo um futuro mais esperançoso e repleto de oportunidades para todos.
            </p>
          </motion.div>
        </div>
      </section>
